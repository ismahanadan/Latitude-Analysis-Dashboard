...
I'll be creating a visualization dashboard website using visualizations we've created in a past assignment. Specifically, I'll be plotting [weather data](Resources/cities.csv).
